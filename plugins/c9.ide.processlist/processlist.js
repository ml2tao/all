    ...
    function main(options, imports, register) {
        ...
        var plugin = new Dialog("Ajax.org", main.consumes, {
            ...
            elements: [
                ...
                { type: "filler" },
                { type: "button", id: "btnKill", caption: "关闭进程", onclick: kill, disabled: true },
                { type: "button", id: "btnForceKill", color: "red", caption: "强制关闭", onclick: forceKill, disabled: true }
            ]
        });
        ...
        function load() {
            ...
            menus.addItemByPath("工具/进程列表", new ui.item({
