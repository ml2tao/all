    ...
    function main(options, imports, register) {
        ...
        function load(){
            ...
            if (!options.hideButton) {
                ...
                menus.addItemByPath("工具/预览/", submenu, 1000, handle);
                liveMenuItem = new ui.item({
                    onclick: function(){ commands.exec("preview"); }
                });
                menus.addItemByPath("工具/预览/即时预览文件",
                    liveMenuItem, 100, handle);
                menus.addItemByPath("工具/预览/即时预览应用程序", 
                    new ui.item({
                        onclick: function(){
