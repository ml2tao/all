...
define(function(require, exports, module) {
    ...
    function main(options, imports, register) {
        ...
        function load(){
            ...
            // General Menus
            menus.addItemByPath("文件/~", new ui.divider(), 100000, plugin);
            menus.addItemByPath("文件/关闭文件", new ui.item({
                command: "closetab"
            }), 110000, plugin);
            menus.addItemByPath("文件/关闭所有文件", new ui.item({
                command: "closealltabs"
            }), 120000, plugin);

            mnuTabs = new ui.menu();
            
            menus.addItemByPath("窗口/标签", mnuTabs, 10100, plugin);
            menus.addItemByPath("窗口/标签/关闭面板", new ui.item({
                command: "closepane"
            }), 100, plugin);
            menus.addItemByPath("窗口/标签/关闭面板内的所有文件", new ui.item({
                command: "closealltabs"
            }), 200, plugin);
            menus.addItemByPath("窗口/标签/关闭所有标签除了当前标签", new ui.item({
                command: "closeallbutme"
            }), 300, plugin);
            
            menus.addItemByPath("窗口/标签/~", new ui.divider(), 1000000, plugin);
            menus.addItemByPath("窗口/标签/分割成两行", new ui.item({
                command: "vsplit"
            }), 1000100, plugin);
            menus.addItemByPath("窗口/标签/分割成两列", new ui.item({
                command: "hsplit"
            }), 1000200, plugin);
            menus.addItemByPath("窗口/标签/~", new ui.divider(), 1000300, plugin);
            
            menus.addItemByPath("窗口/标签/~", new apf.label({
                "class"   : "splits",
            ...
            menus.addItemByPath("窗口/~", new ui.divider(), 9000, plugin);

            menus.addItemByPath("窗口/导航/", null, 9100, plugin);

            menus.addItemByPath("窗口/导航/去最右边的标签", new ui.item({
                command: "gototabright"
            }), 100, plugin);

            menus.addItemByPath("窗口/导航/去最左边的标签", new ui.item({
                command: "gototableft"
            }), 200, plugin);

            menus.addItemByPath("窗口/导航/下一个标签", new ui.item({
                command: "nexttab"
            }), 300, plugin);

            menus.addItemByPath("窗口/导航/上一个标签", new ui.item({
                command: "previoustab"
            }), 400, plugin);

            menus.addItemByPath("窗口/导航/~", new ui.divider(), 500, plugin);
            
            menus.addItemByPath("窗口/导航/移向右边的标签", new ui.item({
                command: "movetabright"
            }), 600, plugin);
            menus.addItemByPath("窗口/导航/移向左边的标签", new ui.item({
                command: "movetableft"
            }), 700, plugin);
            menus.addItemByPath("窗口/导航/移向上边的标签", new ui.item({
                command: "movetabup"
            }), 800, plugin);
            menus.addItemByPath("窗口/导航/移向下边的标签", new ui.item({
                command: "movetabdown"
            }), 900, plugin);
            
            menus.addItemByPath("窗口/导航/~", new ui.divider(), 1000, plugin);

            menus.addItemByPath("窗口/导航/历史中的下一个面板", new ui.item({
                command: "nextpane"
            }), 1100, plugin);

            menus.addItemByPath("窗口/导航/历史中的上一个面板", new ui.item({
                command: "previouspane"
            }), 1200, plugin);
            
            // Tab Helper Menu
            menus.addItemByPath("窗口/~", new ui.divider(), 10000, plugin);
