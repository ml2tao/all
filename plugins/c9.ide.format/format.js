define(function(require, exports, module) {
    ...
    function main(options, imports, register) {
        ...
        function load() {
            ...
            menus.addItemByPath("编辑/代码格式化", mnuFormat, 1400, plugin);
            
            menus.addItemByPath("编辑/代码格式化/自动格式化", new ui.item({
                selected: true,
                value: "auto",
                command: "formatcode"
            }), 100, plugin);
            menus.addItemByPath("编辑/代码格式化/~", new ui.divider(), 200, plugin);
        }
        ...
        function addFormatter(caption, mode, plugin) {
            menus.addItemByPath("编辑/代码格式化/" + caption, new ui.item({
                value: mode,
