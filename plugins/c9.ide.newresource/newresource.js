define(function(require, exports, module) {
    ...
    function main(options, imports, register) {
        ...
        function load(callback) {
            ...
            menus.addItemByPath("文件/创建文件", new ui.item({
                disabled: readonly,
                command: "newfile"
            }), 100, plugin);
            menus.addItemByPath("文件/从模版创建文件", new ui.item({
                disabled: readonly,
            }), 200, plugin);
            
            // menus.addItemByPath("文件/New Folder", new ui.item({
            //     disabled: readonly,
            //     command: "newfolder"
            // }), 300, plugin);
            // menus.addItemByPath("文件/~", new ui.divider(), 400, plugin);
        ...
        function addFileTemplate(data, forPlugin) {
            ...
            list.forEach(function(item){
                menus.addItemByPath("文件/从模版创建文件/" + item.caption, new ui.item({
                    disabled: readonly,
                    onclick: function(){
