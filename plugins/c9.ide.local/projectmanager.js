...
define(function(require, exports, module) {
    ...
    function main(options, imports, register) {
        ...
        function load(){
            ...
            menus.addItemByPath("文件/New Window", new ui.item({
                value: "",
                command: "newWindow"
            }), 250, plugin);
            ...
            menus.addItemByPath("Gospel/~", new ui.divider(), c += 100, plugin);
            
            // projects menu
            menus.addItemByPath("Gospel/Recent Windows/", new ui.menu({
                        ...
                        windowManager.getRecentWindows(function(err, recentWindows) {
                            ...
                            recentWindows.forEach(function(x) {
                                if (!x.isOpen && !dividerAdded) {
                                    dividerAdded = true;
                                    menus.addItemByPath("Gospel/Recent Windows/~", 
