define(function(require, exports, module) {
    ...
    function main(options, imports, register) {
        ...
        handle.on("load", function(){
            ...
            menus.addItemByPath("窗口/终端", new ui.item({
                command: "openterminal"
            }), 30, handle);

            menus.addItemByPath("窗口/导航/~", new ui.divider(), 1500, handle);
            menus.addItemByPath("窗口/导航/Switch Between Editor and Terminal", new ui.item({
