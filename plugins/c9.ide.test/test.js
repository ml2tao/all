define(function(require, exports, module) {
    ...
    function main(options, imports, register) {
        ...
        function load() {
            ...
            menus.addItemByPath("Gospel/Open Your Test Configuration", new ui.item({
        ...
        function drawMenu(){
            ...
            menus.addItemByPath("调试/Run Test", new ui.item({
                command: "runfocussedtest"
            }), 1250, plugin);
            menus.addItemByPath("调试/Run Test with Code Coverage", new ui.item({
