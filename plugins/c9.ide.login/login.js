define(function(require, exports, module) {
    ...
    function main(options, imports, register) {
        ...
        function load() {
            ...
            if (!c9.local) {
                menus.addItemByPath("Gospel/~", new apf.divider(), 2000000, plugin);
                menus.addItemByPath("Gospel/退出Gospel", new apf.item({
                    onclick: function(){
                        signout();
                    }
                }), 2000100, plugin);
