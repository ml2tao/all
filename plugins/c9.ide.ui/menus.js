define(function(require, exports, module) {
    ...
    function main(options, imports, register) {
         ...
         *     menus.addItemByPath("编辑/~", new Divider(), 300, plugin);
         * 
         *     // Add the cut, copy and paste menu items below the divider at positions 400 - 600
         *     menus.addItemByPath("编辑/Cut", new MenuItem({ command : "cut" }), 400, plugin);
         *     menus.addItemByPath("编辑/Copy", new MenuItem({ command : "copy" }), 500, plugin);
         *     menus.addItemByPath("编辑/Paste", new MenuItem({ command : "paste" }), 600, plugin);    
         * 
        ...
        plugin.freezePublicAPI({
             ...
             *     menus.addItemByPath("文件/Save As...", item, 400, plugin);
             * 
             ...
             *     menus.addItemByPath("文件/Extra/Test", item, 100, plugin);
             * 
             * Any time after executing the code above you can create the
             * "Extra" item:
             * 
             *     menus.addItemByPath("文件/Extra", null, 300, plugin);
             * 
