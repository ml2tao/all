        ...
        describe('menus', function() {
            ...
            describe("setRootMenu() addItemByPath() expand() collapse() click()", function(){
                ...
                it('should create submenus stacked and ordered properly', function(done) {
                    ...
                    menus.addItemByPath("文件/~", new apf.divider(), 100, plugin);
                    menus.addItemByPath("文件/Quit", new apf.item({
                        onclick: function(){ count++; }
                    }), 200, plugin);
                    menus.addItemByPath("文件/Hello", new apf.item({
                    }), 10, plugin);
                ...
                it('should create submenus of depth 5', function(done) {
                    ...
                    menus.addItemByPath("文件/First", new apf.item(), plugin);
                    menus.addItemByPath("文件/First/Second", new apf.item(), plugin);
                    menus.addItemByPath("文件/First/Second/Third", new apf.item(), plugin);
                    menus.addItemByPath("文件/First/Second/Third/Fourth", new apf.item(), plugin);
                    
                    menus.addItemByPath("文件/First/Second/Third/Fourth/Fifth", 
                        new apf.item({
                            onclick: function(){ count++; }
                        }), 200, plugin);
