...
define(function(require, exports, module) {
    ...
    function main(options, imports, register) {
        ...
        function load() {
            ...
            if (!ENABLED) {
                menus.addItemByPath("工具/开发者/开启调试模式", new ui.item({
                    onclick: function(){
            ...
            if (ENABLED) {
                notify("<div class='c9-readonly'>您已经开启 <span style='color:rgb(245, 234, 15)'>调试</span> 模式. "
                    + "别忘记打开调试器查看错误.", 
                    false);
            }
            ...
            menus.addItemByPath("工具/开发者/刷新自定义控件", new ui.item({
